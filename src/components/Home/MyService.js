...
const MyService = () => {
    return (
        <div className='my-9 px-4'>
            <h1 className='text-center lg:text-3xl xl:text-4xl text-2xl'><span className='title relative py-7'>My Services</span></h1>
            <div className='grid  md:grid-cols-2 lg:grid-cols-3 gap-7 mt-12'>
                <div className='service-card xl:p-9 max-w-sm hover:shadow-xl p-2 '>
